...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xd:doc scope="stylesheet">
        <xd:desc>
            ...
            <xd:p>INT0027 BNY Mellon Positive Pay Document Transform XSLT</xd:p>
        </xd:desc>
    </xd:doc>
    ...
    <xsl:variable name="CountCheck">
        <xsl:value-of select="count(wd:Get_Payments_Response/wd:Response_Data[1]/wd:Payment[1]/wd:Payment_Data[1]/wd:Payment_Group_Data[1]/wd:Payment_Type_Reference[1]/@wd:Descriptor='Direct Deposit')"/>
    </xsl:variable>
    
    <xsl:variable name="SumCheck">
        <xsl:choose>
            <xsl:when test="wd:Get_Payments_Response/wd:Response_Data[1]/wd:Payment[1]/wd:Payment_Data[1]/wd:Payment_Group_Data[1]/wd:Payment_Type_Reference[1]/@wd:Descriptor='Direct Deposit'">
    ...
    <xsl:template match="wd:Get_Payments_Response/wd:Response_Data/wd:Payment">
        ...
        <File >
            ...
            <ServiceHeader xtt:endTag="&#xA;">
                ...
                <Filler xtt:fixedLength="30" xtt:attribute="Record 2 Filler"></Filler>
          ...
          <!--<xd:desc>Payee Header Record</xd:desc>-->
            <PayeeHeaderRecord xtt:endTag="&#xA;">
                <RecordType xtt:fixedLength="1" xtt:attribute="Record Type 8"></RecordType>
                <TotalNumberofAdd xtt:fixedLength="10" xtt:align="right" xtt:paddingCharacter="0"><xsl:value-of select="$CountCheck"/></TotalNumberofAdd>
                <TotalDollarAmountAdd xtt:fixedLength="12" xtt:numberFormat="##########" xtt:align="right" xtt:paddingCharacter="0"><xsl:value-of select="$SumCheck*100"/></TotalDollarAmountAdd>
                <TotalNumberofVoid xtt:fixedLength="10" xtt:align="right" xtt:paddingCharacter="0"></TotalNumberofVoid>
                <TotalDollarAmountVoid xtt:fixedLength="12" xtt:numberFormat="##########" xtt:align="right" xtt:paddingCharacter="0"></TotalDollarAmountVoid>
            ...
            <LienHeaderRecord xtt:endTag="&#xA;">
                ...
                <TotalNumberofAdd xtt:fixedLength="6" xtt:align="right" xtt:paddingCharacter="0"><xsl:value-of select="$CountCheck"/></TotalNumberofAdd>
